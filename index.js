...
function title() {
      console.clear()    
      console.log('\x1b[1;31m×\x1b[1;37m>', '<\x1b[1;32m📍︎\x1b[1;37m>', color('connect to'), 'Whatsaap_Web')	
	  console.log(color(figlet.textSync(`${spc2}Iron-MD`, {
        font: 'Standard',
	  ...
	  console.log(color(`[•]`, 'aqua'), color(`Owner       : Shwva_Tyyy`, 'red'))
	  console.log(color(`[•]`, 'aqua'), color(`Devoloper    : @shwva_tyyy`, 'magenta'))
}
//COLOR
colors.setTheme({
warn:'yellow',
...
const { state, saveState } = useSingleFileAuthState('./session-ironbot.json')
const fs = require('fs')
...
// OTHER
    ...
    let pa7rick = await conn.sendTextWithMentions(dill.from, `*Iron-Bot* tidak bisa menerima panggilan ${dill.isVideo ? `video` : `suara`}. Maaf @${dill.from.split('@')[0]} kamu akan diblockir. Jika tidak sengaja silahkan hubungi Owner untuk dibuka !`)
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await conn.getName(i + '@s.whatsapp.net')}\nFN:${await conn.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET: shawavatritya@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/shwva_tyyy\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Bogor, Jawa Barat, Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
